...
public class Ejercicio2 {
	...
	public static void main(String[] args) {
        ...
        numerosEnteros = agregarNumeros(numerosEnteros);
        mostrar(numerosEnteros);
	 ...
	 public static ArrayList<Integer> agregarNumeros(ArrayList<Integer> numeros) {
	    ...
	    public static void mostrar(ArrayList<Integer> numerosImprimir) {
	        for (Integer numero: numerosImprimir) {
	            System.out.print(numero+" ");
	        }
	        int cantidad = numerosImprimir.size();
	        System.out.println("\nEl tama�o de la lista es de: "+cantidad);
	    }
